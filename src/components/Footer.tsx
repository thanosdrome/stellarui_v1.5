    ...
    <footer className="w-full bg-dark-background text-white relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-[73px] pt-16 pb-8">
        ...
        <div className="relative">
          <h1 
            className="text-[200px] font-bold leading-none bg-[linear-gradient(0deg,rgba(69, 69, 69, 1) 35%, rgba(10, 10, 10, 1) 100%)] tracking-wider select-none pointer-events-none bg-clip-text"
            style={{
